...
A good looking Flutter app for showing meal items. It can be used for a restaurant app. No database attached yet.
...
- Rename the project folder to 'meals', or you can change the name later.
